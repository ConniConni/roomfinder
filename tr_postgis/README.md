...
| ID    | 分類 | テスト項目（観点）                                       | 期待される結果                                                                            |
| :---- | :--- | :------------------------------------------------------- | :---------------------------------------------------------------------------------------- |
| SC-N1 | 正常 | 例外が発生することなく処理が完了するケースの確認         | ・取得したリストの長さが6であること<br>・INFOログに「---- 正常終了 ----」と出力されること |
| SC-N2 | 正常 | スレッドの一部で取得結果が0のものがあるケースの確認      | ・取得したリストの長さが3であること・INFOログに「---- 正常終了 ----」と出力されること     |
| SC-N3 | 正常 | 例外が発生せず、取得結果が0のケースの確認                | ・save_to_csvが呼ばれないこと<br>・INFOログに「---- 正常終了 ----」と出力されること       |
| SC-E1 | 異常 | 一部のスレッドで例外が発生して処理が完了するケースの確認 | ・save_to_csvが呼ばれること<br>・INFOログに「---- 異常終了 ----」と出力されること         |
| SC-E2 | 異常 | 途中で例外が発生して処理が完了するケースの確認           | ・取得したリストの長さが3であること・INFOログに「---- 正常終了 ----」と出力されること     |
